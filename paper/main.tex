...
The nine benchmark datasets are publicly available from the UCR and UEA Time Series Classification Archives at \url{https://www.timeseriesclassification.com/}; the official predefined training and test files were used without resplitting. Online Resource~1 supplies the executable reference code, frozen dependencies, split instructions, MultiROCKET row-level results, and integrity-checked validation receipts needed to inspect the reported computational workflow.
